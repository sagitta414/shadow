...
export const VILLAINS: Villain[] = [
  ...
  { name: "Nebula",              universe: "Marvel", scheme: "Tear the universe apart and rebuild it in her own image — no matter how many timelines she must destroy",icon: "🌌" },
  { name: "Emma Frost",          universe: "Marvel", scheme: "Rule mutantkind from a diamond throne while bending every powerful mind to her immaculate will",        icon: "💎" },
  { name: "Dark Phoenix",        universe: "Marvel", scheme: "Consume stars and worlds alike as the omnipotent cosmic fire given human form",                          icon: "🔥" },
  { name: "Destiny",             universe: "Marvel", scheme: "Orchestrate mutantkind's future from the shadows using precognition that sees centuries ahead",          icon: "👁" },
  { name: "Anaconda",            universe: "Marvel", scheme: "Constrict every obstacle — hero or otherwise — into submission with her Serpent Society loyalty",        icon: "🐍" },
  { name: "Lady Bullseye",       universe: "Marvel", scheme: "Deliver surgical assassinations for the Hand with lethal precision that rivals the original Bullseye",   icon: "🎯" },
  { name: "Mysteria",            universe: "Marvel", scheme: "Surpass her predecessor with illusion and chemistry, fooling the world one perfectly staged scene at a time", icon: "🎭" },
  ...
  { name: "Knockout",            universe: "DC",     scheme: "Crush everything in her path with Female Fury strength and revel in the pure joy of destruction",       icon: "👊" },
  { name: "Doctor Cyber",        universe: "DC",     scheme: "Use her cybernetically-enhanced genius to destroy Wonder Woman and everything the Amazon stands for",    icon: "🤖" },
  { name: "Veronica Cale",       universe: "DC",     scheme: "Destroy Wonder Woman's legacy using billions, political power, and cold calculated corporate ruthlessness", icon: "💼" },
  { name: "White Rabbit",        universe: "DC",     scheme: "Stay three moves ahead of Batman while orchestrating heists with theatrical Lewis Carroll-styled flair", icon: "🐇" },
  { name: "Phobia",              universe: "DC",     scheme: "Paralyse every enemy by manifesting their deepest darkest fears into inescapable psychic reality",       icon: "😱" },
  { name: "Stompa",              universe: "DC",     scheme: "Stomp cities flat for Darkseid as Apokolips's most brutishly powerful Female Fury",                     icon: "👢" },
  { name: "Black Alice",         universe: "DC",     scheme: "Steal any magic-user's powers and weaponise them against a world that never showed her compassion",     icon: "🖤" },
  { name: "Tigress",             universe: "DC",     scheme: "Hunt heroes with martial arts precision as the Injustice Society's most relentless and skilled predator",icon: "🐯" },
  { name: "Mortalla",            universe: "DC",     scheme: "Rule Apokolips at Darkseid's side and eliminate any rival who dares look twice at her husband's throne",icon: "👑" },
  { name: "Shadow Thief",        universe: "DC",     scheme: "Strike from the shadows as a dimensional thief who can phase through anything and steal the impossible", icon: "🌑" },
  // CW / Arrowverse
