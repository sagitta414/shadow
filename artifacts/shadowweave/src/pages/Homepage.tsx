...
const PRIMARY_MODES = [
  {
    ...
    desc: "118+ heroines across Marvel, DC, CW, The Boys, Power Rangers, and Animated universes. Pick your heroine, choose your villain, and generate a multi-chapter dark thriller.",
    stats: [["118+", "Heroines"], ["53", "Villains"], ["6", "Universes"]] as [string,string][],
    features: ["Marvel · DC · CW · The Boys", "Power Rangers · Animated · Disney", "Multi-chapter AI story engine"],
    cta: "Enter the Forge",
    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "transparent" }}>
      ...
      <nav className="hp-nav" style={{
        ...
        <div className="hp-nav-stats" style={{ display: "flex", gap: "2.25rem", alignItems: "center" }}>
          {[["3", "Story Modes"], ["118+", "Heroines"], ["Venice AI", "Engine"], ["4", "Themes"]].map(([v, l]) => (
